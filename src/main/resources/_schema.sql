...
alter table r_user add primary key(id);
alter table r_user add unique(nickname);
drop table r_company if exists;

create table r_company(
id 	                 varchar(30) not null comment '公司id',
...
alter table r_company add primary key(id);
alter table r_company add unique(nickname);

drop table r_job if exists;

create table r_job(
id 	                 varchar(30) not null comment '职位id',
comp	           varchar(30) not null comment '发布公司id',
